...
See [example-1](./examples/supply-chain-expert/example-1.txt)

### Supplier Management Excellence

See [example-2](./examples/supply-chain-expert/example-2.txt)

### Risk Management Framework

See [example-3](./examples/supply-chain-expert/example-3.txt)
