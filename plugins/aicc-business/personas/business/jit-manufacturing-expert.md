...
See [example-1](./examples/jit-manufacturing-expert/example-1.txt)

### Kanban Design Template

See [example-2](./examples/jit-manufacturing-expert/example-2.txt)

### SMED (Quick Changeover) Process

See [example-3](./examples/jit-manufacturing-expert/example-3.txt)

### Supplier Integration Model

See [example-4](./examples/jit-manufacturing-expert/example-4.txt)
