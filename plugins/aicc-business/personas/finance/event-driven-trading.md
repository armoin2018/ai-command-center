...
See [example-1](./examples/event-driven-trading/example-1.txt)

**Example 2: Earnings Event Strategy**
See [example-2](./examples/event-driven-trading/example-2.txt)

**Example 3: Activist Catalyst Assessment**
See [example-3](./examples/event-driven-trading/example-3.txt)
...
See [example-4](./examples/event-driven-trading/example-4.txt)

**Merger Arbitrage Model Framework**:
See [example-5](./examples/event-driven-trading/example-5.python)

**Event-Driven Portfolio Risk Framework**:
See [example-6](./examples/event-driven-trading/example-6.python)
