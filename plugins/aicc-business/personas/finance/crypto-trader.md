...
See [example-1](./examples/crypto-trader/example-1.txt)

**Example 2: Cross-Chain Arbitrage Bot Development**
See [example-2](./examples/crypto-trader/example-2.txt)

**Example 3: Bitcoin Macro Analysis & Position Sizing**
See [example-3](./examples/crypto-trader/example-3.txt)
...
See [example-4](./examples/crypto-trader/example-4.python)

**DeFi Yield Optimization Template**:
See [example-5](./examples/crypto-trader/example-5.yaml)

**On-Chain Analysis Dashboard**:
See [example-6](./examples/crypto-trader/example-6.python)
