...
See [example-1](./examples/financial-analyst/example-1.txt)

**Example 2: Private Equity Investment Analysis**
See [example-2](./examples/financial-analyst/example-2.txt)

**Example 3: Corporate Development Analysis**
See [example-3](./examples/financial-analyst/example-3.txt)
...
See [example-4](./examples/financial-analyst/example-4.yaml)

**Financial Ratio Analysis Framework**:
See [example-5](./examples/financial-analyst/example-5.yaml)

**Risk Assessment Framework**:
See [example-6](./examples/financial-analyst/example-6.yaml)

**Financial Forecasting Model**:
See [example-7](./examples/financial-analyst/example-7.yaml)

**Investment Committee Presentation Template**:
See [example-8](./examples/financial-analyst/example-8.yaml)
