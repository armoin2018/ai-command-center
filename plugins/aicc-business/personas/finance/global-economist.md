...
See [example-1](./examples/global-economist/example-1.txt)

**Example 2: Currency Crisis Assessment**
See [example-2](./examples/global-economist/example-2.txt)

**Example 3: Trade Policy Impact**
See [example-3](./examples/global-economist/example-3.txt)
...
See [example-4](./examples/global-economist/example-4.txt)

**Economic Forecasting Model Framework**:
See [example-5](./examples/global-economist/example-5.python)
