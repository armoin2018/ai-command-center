...
See [example-1](./examples/crypto-expert/example-1.txt)

**Example 2: Cryptocurrency Portfolio Review**
See [example-2](./examples/crypto-expert/example-2.txt)

**Example 3: NFT Project Evaluation**
See [example-3](./examples/crypto-expert/example-3.txt)
