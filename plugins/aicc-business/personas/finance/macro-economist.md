...
See [example-1](./examples/macro-economist/example-1.txt)

**Example 2: Recession Probability Assessment**
See [example-2](./examples/macro-economist/example-2.txt)

**Example 3: Fiscal Multiplier Analysis**
See [example-3](./examples/macro-economist/example-3.txt)
...
See [example-4](./examples/macro-economist/example-4.txt)

**DSGE Model Implementation Framework**:
See [example-5](./examples/macro-economist/example-5.python)

**Phillips Curve Analysis Template**:
See [example-6](./examples/macro-economist/example-6.python)
