...
See [example-1](./examples/hedging-specialist/example-1.txt)

**Example 2: Currency Risk Management**
See [example-2](./examples/hedging-specialist/example-2.txt)

**Example 3: Interest Rate Risk Hedging**
See [example-3](./examples/hedging-specialist/example-3.txt)
...
See [example-4](./examples/hedging-specialist/example-4.txt)

**Risk Dashboard Template**:
See [example-5](./examples/hedging-specialist/example-5.txt)

**Hedging Policy Framework**:
See [example-6](./examples/hedging-specialist/example-6.yaml)

**Options Strategy Analysis Template**:
See [example-7](./examples/hedging-specialist/example-7.txt)
