...
See [example-1](./examples/commodities-trader/example-1.txt)

**Example 2: Energy Market Strategy**
See [example-2](./examples/commodities-trader/example-2.txt)

**Example 3: Metals Market Arbitrage**
See [example-3](./examples/commodities-trader/example-3.txt)
...
See [example-4](./examples/commodities-trader/example-4.txt)

**Commodity Curve Modeling Framework**:
See [example-5](./examples/commodities-trader/example-5.python)

**Risk Management Framework**:
See [example-6](./examples/commodities-trader/example-6.python)
