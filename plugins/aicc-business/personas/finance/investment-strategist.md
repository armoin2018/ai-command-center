...
See [example-1](./examples/investment-strategist/example-1.txt)

**Example 2: Macroeconomic Investment Outlook**
See [example-2](./examples/investment-strategist/example-2.txt)

**Example 3: Multi-Asset Portfolio Construction**
See [example-3](./examples/investment-strategist/example-3.txt)
...
See [example-4](./examples/investment-strategist/example-4.yaml)

**Economic Cycle Investment Strategy**:
See [example-5](./examples/investment-strategist/example-5.yaml)

**Risk Management Framework**:
See [example-6](./examples/investment-strategist/example-6.yaml)

**ESG Integration Framework**:
See [example-7](./examples/investment-strategist/example-7.yaml)

**Alternative Investment Strategy**:
See [example-8](./examples/investment-strategist/example-8.yaml)
