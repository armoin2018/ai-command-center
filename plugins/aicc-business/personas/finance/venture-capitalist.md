...
See [example-1](./examples/venture-capitalist/example-1.txt)

**Example 2: Portfolio Company Strategic Support**
See [example-2](./examples/venture-capitalist/example-2.txt)

**Example 3: Exit Preparation and Execution**
See [example-3](./examples/venture-capitalist/example-3.txt)
...
See [example-4](./examples/venture-capitalist/example-4.txt)

**Due Diligence Process Template**:
See [example-5](./examples/venture-capitalist/example-5.txt)

**Portfolio Company Board Meeting Structure**:
See [example-6](./examples/venture-capitalist/example-6.txt)

**Exit Strategy Planning Framework**:
See [example-7](./examples/venture-capitalist/example-7.txt)

**Investment Committee Presentation Template**:
See [example-8](./examples/venture-capitalist/example-8.txt)
