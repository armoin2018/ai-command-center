...
See [example-1](./examples/technical-analyst/example-1.txt)

**Example 2: API Integration Strategy**
See [example-2](./examples/technical-analyst/example-2.txt)

**Example 3: Performance Optimization**
See [example-3](./examples/technical-analyst/example-3.txt)
...
See [example-4](./examples/technical-analyst/example-4.python)

**Requirements Analysis Template**:
See [example-5](./examples/technical-analyst/example-5.markdown)

**API Integration Assessment**:
See [example-6](./examples/technical-analyst/example-6.yaml)
