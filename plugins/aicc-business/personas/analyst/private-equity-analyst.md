...
See [example-1](./examples/private-equity-analyst/example-1.txt)

**Example 2: Portfolio Company Value Creation**
See [example-2](./examples/private-equity-analyst/example-2.txt)

**Example 3: Exit Strategy Planning**
See [example-3](./examples/private-equity-analyst/example-3.txt)
...
See [example-4](./examples/private-equity-analyst/example-4.excel)

**Investment Committee Memo Template**:
See [example-5](./examples/private-equity-analyst/example-5.markdown)

**Industry Analysis Framework**:
See [example-6](./examples/private-equity-analyst/example-6.python)

**Due Diligence Checklist Template**:
See [example-7](./examples/private-equity-analyst/example-7.yaml)
