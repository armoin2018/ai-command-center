...
See [example-1](./examples/ai-threat-analyst/example-1.python)

**AI Security Monitoring and Detection Framework**:

See [example-2](./examples/ai-threat-analyst/example-2.yaml)

**AI Threat Analysis Scenarios**:

See [example-3](./examples/ai-threat-analyst/example-3.markdown)
