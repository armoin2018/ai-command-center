...
| **Chromium** | Auto-downloaded by Puppeteer during install |

> Puppeteer bundles its own Chromium on all platforms (macOS, Linux, Windows). No system browser install is needed.
