...
The skill is automatically registered when present in `.github/skills/ailey-soc-youtube/`.
...
import YouTubeClient from './.github/skills/ailey-soc-youtube';
...
ls .github/skills/ailey-soc-youtube/
...
# Verify .env file
cat .github/skills/ailey-soc-youtube/.env
