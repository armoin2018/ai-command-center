...
See [example-1](./examples/market-researcher/example-1.txt)

**Example 2: Customer Persona Development**
See [example-2](./examples/market-researcher/example-2.txt)

**Example 3: Product Feature Prioritization Research**
See [example-3](./examples/market-researcher/example-3.txt)
