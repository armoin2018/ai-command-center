...
See [example-1](./examples/social-media-expert/example-1.txt)

**Example 2: Influencer Campaign Management**
See [example-2](./examples/social-media-expert/example-2.txt)

**Example 3: Crisis Management Response**
See [example-3](./examples/social-media-expert/example-3.txt)
