...
See [example-1](./examples/javascript-game-developer/example-1.txt)

**Example 2: Multiplayer Real-Time Game**
See [example-2](./examples/javascript-game-developer/example-2.txt)

**Example 3: Monetized Casual Game**
See [example-3](./examples/javascript-game-developer/example-3.txt)
...
See [example-4](./examples/javascript-game-developer/example-4.javascript)

**Canvas 2D Game Loop**:
See [example-5](./examples/javascript-game-developer/example-5.javascript)
