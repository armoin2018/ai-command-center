...
| Aspect | ailey-soc-linkedin | ailey-soc-instagram | ailey-soc-facebook |
|--------|----------------|-----------------|----------------|
...
```bash
cd .github/skills/ailey-soc-linkedin
npm install
```
...
- **ailey-tools-tag-n-rag**: Index LinkedIn posts for searchable archive
