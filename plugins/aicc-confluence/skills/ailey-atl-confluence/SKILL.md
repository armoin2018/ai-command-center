---
id: ailey-atl-confluence
name: ailey-atl-confluence
...
The ailey-atl-confluence skill provides complete integration with Atlassian Confluence:
...
```typescript
// 1. Read PLAN.json with ailey-admin-manage-plan
