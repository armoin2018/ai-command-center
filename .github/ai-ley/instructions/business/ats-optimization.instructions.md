...
See [example-1](./examples/ats-optimization/example-1.markdown)
...
See [example-3](./examples/ats-optimization/example-3.python)

### ATS Scoring Algorithm

See [example-4](./examples/ats-optimization/example-4.javascript)
...
See [example-5](./examples/ats-optimization/example-5.markdown)
...
See [example-7](./examples/ats-optimization/example-7.yaml)
