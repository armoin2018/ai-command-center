...
See [example-1](./examples/material-design/example-1.bash)

## Project Structure

See [example-2](./examples/material-design/example-2.txt)
...
[code example]
See [example-3](./examples/material-design/example-3.txt)[language]
// Example implementation
[code example]
See [example-4](./examples/material-design/example-4.txt)[format]
# Configuration options
[example configuration]
See [example-5](./examples/material-design/example-5.txt)[format]
# Configuration options
[example configuration]
See [example-6](./examples/material-design/example-6.txt)bash
# Development
[dev server command]
...
[add new package]
[update packages]
See [example-7](./examples/material-design/example-7.txt)bash
[debug commands]
```
