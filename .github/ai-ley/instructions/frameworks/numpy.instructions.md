---
name: numpy
description: NumPy (Finance) Framework Instructions for AI Agents
keywords: [numpy, numerical computing, finance, time-series analysis, framework, guidelines, assistant, frameworks, instructions]

---
# NumPy (Finance) — AI Agent Numerical Guide
