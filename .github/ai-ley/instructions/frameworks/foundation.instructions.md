---
name: foundation
description: Foundation CSS Framework Instructions for AI Agents
keywords: [foundation, css framework, responsive design, web development, guidelines, assistant, frameworks, instructions]
---
...
See [example-1](./examples/foundation/example-1.bash)

## Project Structure

See [example-2](./examples/foundation/example-2.txt)
...
[code example]
See [example-3](./examples/foundation/example-3.txt)[language]
// Example implementation
[code example]
See [example-4](./examples/foundation/example-4.txt)[format]
# Configuration options
[example configuration]
See [example-5](./examples/foundation/example-5.txt)[format]
# Configuration options
[example configuration]
See [example-6](./examples/foundation/example-6.txt)bash
# Development
[dev server command]
...
[add new package]
[update packages]
See [example-7](./examples/foundation/example-7.txt)bash
[debug commands]
```
