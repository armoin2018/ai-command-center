...
See [example-1](./examples/brutalism/example-1.css)

### Color System

See [example-2](./examples/brutalism/example-2.css)
...
See [example-4](./examples/brutalism/example-4.html)
...
See [example-5](./examples/brutalism/example-5.css)
...
See [example-6](./examples/brutalism/example-6.css)
...
See [example-7](./examples/brutalism/example-7.javascript)
