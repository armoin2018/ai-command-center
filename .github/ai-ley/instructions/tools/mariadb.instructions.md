...
See [example-1](./examples/mariadb/example-1.dockerfile)

See [example-2](./examples/mariadb/example-2.ini)

See [example-3](./examples/mariadb/example-3.yaml)

See [example-4](./examples/mariadb/example-4.bash)

### Kubernetes StatefulSet for MariaDB Galera Cluster

See [example-5](./examples/mariadb/example-5.yaml)
...
See [example-7](./examples/mariadb/example-7.bash)
...
See [example-9](./examples/mariadb/example-9.sql)

### Advanced Query Patterns

See [example-10](./examples/mariadb/example-10.sql)
...
See [example-12](./examples/mariadb/example-12.sql)
...
See [example-13](./examples/mariadb/example-13.sql)
...
See [example-14](./examples/mariadb/example-14.bash)

#### Configuration Optimization

See [example-15](./examples/mariadb/example-15.ini)
