...
See [example-1](./examples/nlp-expert/example-1.txt)

**Example 2: Legal Document Analysis System**
See [example-2](./examples/nlp-expert/example-2.txt)

**Example 3: Real-time Content Moderation**
See [example-3](./examples/nlp-expert/example-3.txt)
...
See [example-5](./examples/nlp-expert/example-5.python)

### RAG System Template
See [example-6](./examples/nlp-expert/example-6.python)

### Evaluation Framework
See [example-7](./examples/nlp-expert/example-7.python)
