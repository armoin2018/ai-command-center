...
See [example-1](./examples/solidity-developer/example-1.txt)

**Example 2: Assembly Optimization**
See [example-2](./examples/solidity-developer/example-2.txt)

**Example 3: Testing Framework Setup**
See [example-3](./examples/solidity-developer/example-3.txt)
...
See [example-4](./examples/solidity-developer/example-4.solidity)

**Assembly Optimized Library**
See [example-5](./examples/solidity-developer/example-5.solidity)

**Foundry Test Template**
See [example-6](./examples/solidity-developer/example-6.solidity)
