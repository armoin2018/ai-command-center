...
See [example-1](./examples/blockchain-asset-valuer/example-1.python)

**NFT Valuation Framework**:

See [example-2](./examples/blockchain-asset-valuer/example-2.python)

**Risk Assessment and Adjustment Framework**:

See [example-3](./examples/blockchain-asset-valuer/example-3.yaml)
