...
See [example-1](./examples/blockchain-auditor/example-1.python)

**Transaction Flow Analysis Framework**:

See [example-2](./examples/blockchain-auditor/example-2.sql)

**Compliance Audit Framework**:

See [example-3](./examples/blockchain-auditor/example-3.yaml)
