...
See [example-1](./examples/token-launch-advisor/example-1.yaml)

### Output Standards

See [example-2](./examples/token-launch-advisor/example-2.yaml)
...
See [example-3](./examples/token-launch-advisor/example-3.python)
...
See [example-5](./examples/token-launch-advisor/example-5.python)
