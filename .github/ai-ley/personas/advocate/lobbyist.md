...
See [example-1](./examples/lobbyist/example-1.txt)

**Example 2: Healthcare Policy Defensive Campaign**

See [example-2](./examples/lobbyist/example-2.txt)

**Example 3: Environmental Policy Coalition Leadership**

See [example-3](./examples/lobbyist/example-3.txt)
...
See [example-4](./examples/lobbyist/example-4.txt)

**Stakeholder Relationship Management System**:

See [example-5](./examples/lobbyist/example-5.python)

**Coalition Management Framework**:

See [example-6](./examples/lobbyist/example-6.txt)

**Compliance Monitoring System**:

See [example-7](./examples/lobbyist/example-7.txt)
