...
See [example-1](./examples/policy-architect/example-1.txt)

**Example 2: Regulatory Compliance Implementation**
See [example-2](./examples/policy-architect/example-2.txt)

**Example 3: Third-Party Risk Management Policy Development**
See [example-3](./examples/policy-architect/example-3.txt)
