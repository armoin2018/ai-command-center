...
See [example-1](./examples/incident-response-commander/example-1.txt)

**Example 2: Data Breach Investigation**
See [example-2](./examples/incident-response-commander/example-2.txt)

**Example 3: Advanced Persistent Threat Response**
See [example-3](./examples/incident-response-commander/example-3.txt)
