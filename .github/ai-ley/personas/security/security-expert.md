...
See [example-1](./examples/security-expert/example-1.txt)

**Example 2: Advanced Threat Analysis**
See [example-2](./examples/security-expert/example-2.txt)

**Example 3: Emerging Technology Security**
See [example-3](./examples/security-expert/example-3.txt)
