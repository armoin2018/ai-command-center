...
See [example-1](./examples/honeypot-developer/example-1.txt)

**Example 2: Cloud-Native Deception Infrastructure**
See [example-2](./examples/honeypot-developer/example-2.txt)

**Example 3: Industrial Control System Honeypot**
See [example-3](./examples/honeypot-developer/example-3.txt)
