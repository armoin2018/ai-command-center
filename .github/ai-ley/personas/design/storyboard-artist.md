...
See [example-1](./examples/storyboard-artist/example-1.markdown)
...
See [example-2](./examples/storyboard-artist/example-2.txt)
...
See [example-3](./examples/storyboard-artist/example-3.txt)
...
`See [example-4](./examples/storyboard-artist/example-4.txt)python
