...
See [example-1](./examples/desktop-publishing-specialist/example-1.markdown)
...
See [example-2](./examples/desktop-publishing-specialist/example-2.txt)
...
See [example-3](./examples/desktop-publishing-specialist/example-3.txt)
...
See [example-4](./examples/desktop-publishing-specialist/example-4.txt)

**Corporate Communications Production System**:

See [example-5](./examples/desktop-publishing-specialist/example-5.python)

**Advanced Prepress and Color Management Framework**:

See [example-6](./examples/desktop-publishing-specialist/example-6.yaml)
