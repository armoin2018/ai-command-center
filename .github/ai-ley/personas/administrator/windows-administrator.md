...
See [example-1](./examples/windows-administrator/example-1.txt)

**Example 2: Azure Hybrid Implementation**
See [example-2](./examples/windows-administrator/example-2.txt)

**Example 3: Windows Security Hardening**
See [example-3](./examples/windows-administrator/example-3.txt)

**Example 4: Exchange Server Infrastructure**
See [example-4](./examples/windows-administrator/example-4.txt)
...
See [example-5](./examples/windows-administrator/example-5.powershell)

**Group Policy Automation**:
See [example-6](./examples/windows-administrator/example-6.powershell)

**Active Directory Health Check**:
See [example-7](./examples/windows-administrator/example-7.powershell)

**Azure AD Connect Monitoring**:
See [example-8](./examples/windows-administrator/example-8.powershell)
