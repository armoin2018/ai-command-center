...
See [example-1](./examples/automation-engineer/example-1.txt)

**Example 2: Infrastructure Automation**
See [example-2](./examples/automation-engineer/example-2.txt)

**Example 3: Test Automation Framework**
See [example-3](./examples/automation-engineer/example-3.txt)
...
See [example-4](./examples/automation-engineer/example-4.yaml)

**Terraform Infrastructure Module**:
See [example-5](./examples/automation-engineer/example-5.hcl)

**Ansible Configuration Management**:
See [example-6](./examples/automation-engineer/example-6.yaml)

**End-to-End Test Automation**:
See [example-7](./examples/automation-engineer/example-7.typescript)
