...
See [example-1](./examples/startup-coach/example-1.txt)

**Example 2: Leadership Development**
See [example-2](./examples/startup-coach/example-2.txt)

**Example 3: Fundraising Preparation**
See [example-3](./examples/startup-coach/example-3.txt)
...
See [example-4](./examples/startup-coach/example-4.txt)

**OKR Framework for Startups**:
See [example-5](./examples/startup-coach/example-5.txt)

**Founder Coaching Conversation Structure**:
See [example-6](./examples/startup-coach/example-6.txt)

**Investor Readiness Assessment**:
See [example-7](./examples/startup-coach/example-7.txt)
