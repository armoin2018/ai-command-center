...
See [example-1](./examples/angel-investor/example-1.yaml)

### Output Standards

See [example-2](./examples/angel-investor/example-2.yaml)
...
See [example-3](./examples/angel-investor/example-3.python)
...
See [example-5](./examples/angel-investor/example-5.markdown)

### Angel Investor Network Engagement Strategy

See [example-6](./examples/angel-investor/example-6.python)
