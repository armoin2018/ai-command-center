...
See [example-1](./examples/email-copywriter/example-1.txt)

**Example 2: Re-engagement Campaign**
See [example-2](./examples/email-copywriter/example-2.txt)

**Example 3: Product Launch Campaign**
See [example-3](./examples/email-copywriter/example-3.txt)
