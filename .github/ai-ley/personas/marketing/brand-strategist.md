...
See [example-1](./examples/brand-strategist/example-1.txt)

**Example 2: Brand Repositioning Strategy**
See [example-2](./examples/brand-strategist/example-2.txt)

**Example 3: Brand Crisis Recovery**
See [example-3](./examples/brand-strategist/example-3.txt)
