...
See [example-1](./examples/neuro-linguistic-programming-master-practitioner/example-1.txt)

**Example 2: Leadership Presence Development**
See [example-2](./examples/neuro-linguistic-programming-master-practitioner/example-2.txt)

**Example 3: Organizational Change Communication**
See [example-3](./examples/neuro-linguistic-programming-master-practitioner/example-3.txt)
...
See [example-4](./examples/neuro-linguistic-programming-master-practitioner/example-4.txt)

**Reframing Pattern Template**:
See [example-5](./examples/neuro-linguistic-programming-master-practitioner/example-5.txt)

**Six-Step Reframe Process**:
See [example-6](./examples/neuro-linguistic-programming-master-practitioner/example-6.txt)
