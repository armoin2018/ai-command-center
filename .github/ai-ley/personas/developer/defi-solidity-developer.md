...
See [example-1](./examples/defi-solidity-developer/example-1.txt)

**Example 2: Lending Protocol with Flash Loans**
See [example-2](./examples/defi-solidity-developer/example-2.txt)

**Example 3: Yield Farming Aggregator**
See [example-3](./examples/defi-solidity-developer/example-3.txt)
...
See [example-4](./examples/defi-solidity-developer/example-4.solidity)

**Flash Loan Implementation**
See [example-5](./examples/defi-solidity-developer/example-5.solidity)

**Yield Farming Vault**
See [example-6](./examples/defi-solidity-developer/example-6.solidity)
