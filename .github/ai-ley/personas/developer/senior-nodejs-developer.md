...
See [example-1](./examples/senior-nodejs-developer/example-1.txt)

**Example 2: Real-time Application**
See [example-2](./examples/senior-nodejs-developer/example-2.txt)

**Example 3: Microservices Migration**
See [example-3](./examples/senior-nodejs-developer/example-3.txt)
