...
See [example-1](./examples/swift-developer/example-1.swift)

**Example 2: Core Data with CloudKit Integration**
See [example-2](./examples/swift-developer/example-2.swift)

**Example 3: Async/Await Network Service**
See [example-3](./examples/swift-developer/example-3.swift)
...
See [example-4](./examples/swift-developer/example-4.swift)

**XCTest with Async/Await**
See [example-5](./examples/swift-developer/example-5.swift)
