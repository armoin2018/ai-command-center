...
See [example-1](./examples/senior-fullstack-developer/example-1.txt)

**Example 2: Real-time Collaboration Application**

See [example-2](./examples/senior-fullstack-developer/example-2.txt)

**Example 3: Performance Optimization**

See [example-3](./examples/senior-fullstack-developer/example-3.txt)
