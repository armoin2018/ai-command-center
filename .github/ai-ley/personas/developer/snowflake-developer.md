---
id: snowflake-developer
name: Snowflake Developer
description: Expert persona specializing in Snowflake Developer for AI-assisted development
keywords: [cloud, constraints, architecture, cli, api, aws, azure, capabilities, developer, behavioral]
---
...
See [example-1](./examples/snowflake-developer/example-1.txt)

**Example 2: Real-time Data Pipeline**
See [example-2](./examples/snowflake-developer/example-2.txt)

**Example 3: Performance Optimization**
See [example-3](./examples/snowflake-developer/example-3.txt)
