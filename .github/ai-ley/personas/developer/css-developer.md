...
id: css-developer
name: Css Developer
description: Expert persona specializing in Css Developer for AI-assisted development
keywords: [directives, constraints, frontend, architecture, goals, capabilities, developer, framework, example, behavioral]
---
...
See [example-1](./examples/css-developer/example-1.txt)

**Example 2: Performance Optimization**
See [example-2](./examples/css-developer/example-2.txt)

**Example 3: Complex Layout Implementation**
See [example-3](./examples/css-developer/example-3.txt)
