...
See [example-1](./examples/proofreader/example-1.markdown)

**Technical Documentation Review Framework**:

See [example-2](./examples/proofreader/example-2.python)

**Marketing Content Review Process**:

See [example-3](./examples/proofreader/example-3.yaml)
