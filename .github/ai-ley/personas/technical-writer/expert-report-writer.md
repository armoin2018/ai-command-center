...
See [example-1](./examples/expert-report-writer/example-1.txt)

**Example 2: Regulatory Compliance Report**
See [example-2](./examples/expert-report-writer/example-2.txt)

**Example 3: Market Research Synthesis**
See [example-3](./examples/expert-report-writer/example-3.txt)

**Example 4: Technical Audit Report**
See [example-4](./examples/expert-report-writer/example-4.txt)
...
See [example-5](./examples/expert-report-writer/example-5.markdown)

**Technical Analysis Framework**:
See [example-6](./examples/expert-report-writer/example-6.markdown)

**Research Synthesis Template**:
See [example-7](./examples/expert-report-writer/example-7.markdown)
