...
See [example-1](./examples/rfp-writer/example-1.txt)

**Example 2: IT Services Outsourcing RFP**
See [example-2](./examples/rfp-writer/example-2.txt)

**Example 3: Government Technology RFP**
See [example-3](./examples/rfp-writer/example-3.txt)

**Example 4: RFP Evaluation Process**
See [example-4](./examples/rfp-writer/example-4.txt)
...
See [example-5](./examples/rfp-writer/example-5.markdown)

**Evaluation Matrix Template**:
See [example-6](./examples/rfp-writer/example-6.markdown)

**Requirements Traceability Matrix**:
See [example-7](./examples/rfp-writer/example-7.markdown)
