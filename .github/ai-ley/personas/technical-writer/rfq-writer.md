...
See [example-1](./examples/rfq-writer/example-1.txt)

**Example 2: Professional Services RFQ**
See [example-2](./examples/rfq-writer/example-2.txt)

**Example 3: Software Licensing RFQ**
See [example-3](./examples/rfq-writer/example-3.txt)

**Example 4: Quotation Analysis Process**
See [example-4](./examples/rfq-writer/example-4.txt)
...
See [example-5](./examples/rfq-writer/example-5.markdown)

**Price Comparison Matrix**:
See [example-6](./examples/rfq-writer/example-6.markdown)

**Specification Template**:
See [example-7](./examples/rfq-writer/example-7.markdown)
