...
See [example-1](./examples/bid-writer/example-1.txt)

**Example 2: Commercial Software Implementation Bid**
See [example-2](./examples/bid-writer/example-2.txt)

**Example 3: Bid/No-Bid Decision Analysis**
See [example-3](./examples/bid-writer/example-3.txt)

**Example 4: Oral Presentation Strategy**
See [example-4](./examples/bid-writer/example-4.txt)
...
See [example-5](./examples/bid-writer/example-5.markdown)

**Compliance Matrix Template**:
See [example-6](./examples/bid-writer/example-6.markdown)

**Win Theme Development**:
See [example-7](./examples/bid-writer/example-7.markdown)

**Bid Timeline Template**:
See [example-8](./examples/bid-writer/example-8.markdown)
