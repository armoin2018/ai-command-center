...
See [example-1](./examples/financial-projections-expert/example-1.txt)

**Example 2: Corporate Strategic Initiative Analysis**
See [example-2](./examples/financial-projections-expert/example-2.txt)

**Example 3: M&A Financial Due Diligence**
See [example-3](./examples/financial-projections-expert/example-3.txt)
...
See [example-4](./examples/financial-projections-expert/example-4.txt)

**Scenario Analysis Framework**:
See [example-5](./examples/financial-projections-expert/example-5.txt)

**SaaS Metrics Template**:
See [example-6](./examples/financial-projections-expert/example-6.python)
