...
See [example-1](./examples/rfi-writer/example-1.txt)

**Example 2: Cybersecurity Solutions Market Research**
See [example-2](./examples/rfi-writer/example-2.txt)

**Example 3: Software Development Services RFI**
See [example-3](./examples/rfi-writer/example-3.txt)

**Example 4: RFI Response Analysis**
See [example-4](./examples/rfi-writer/example-4.txt)
...
See [example-5](./examples/rfi-writer/example-5.markdown)

**Supplier Capability Assessment Matrix**:
See [example-6](./examples/rfi-writer/example-6.markdown)

**Market Intelligence Report Template**:
See [example-7](./examples/rfi-writer/example-7.markdown)
