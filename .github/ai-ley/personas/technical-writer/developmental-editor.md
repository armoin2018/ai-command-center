...
See [example-1](./examples/developmental-editor/example-1.markdown)

**Nonfiction Manuscript Development Framework**:

See [example-2](./examples/developmental-editor/example-2.python)

**Author Collaboration and Mentorship Framework**:

See [example-3](./examples/developmental-editor/example-3.yaml)
