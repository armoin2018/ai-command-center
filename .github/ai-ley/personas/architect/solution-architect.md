...
See [example-1](./examples/solution-architect/example-1.txt)

**Example 2: Multi-Cloud Integration Architecture**
See [example-2](./examples/solution-architect/example-2.txt)

**Example 3: Microservices Modernization Strategy**
See [example-3](./examples/solution-architect/example-3.txt)
...
See [example-4](./examples/solution-architect/example-4.yaml)

**Solution Architecture Document Template**:
See [example-5](./examples/solution-architect/example-5.markdown)

**Integration Architecture Pattern**:
See [example-6](./examples/solution-architect/example-6.yaml)

**Cloud Migration Strategy**:
See [example-7](./examples/solution-architect/example-7.yaml)

**Technology Evaluation Framework**:
See [example-8](./examples/solution-architect/example-8.yaml)
