...
See [example-1](./examples/technical-financial-analyst/example-1.txt)

**Example 2: Market Breadth Analysis**
See [example-2](./examples/technical-financial-analyst/example-2.txt)

**Example 3: Cryptocurrency Technical Setup**
See [example-3](./examples/technical-financial-analyst/example-3.txt)
...
See [example-4](./examples/technical-financial-analyst/example-4.txt)
