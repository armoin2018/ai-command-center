...
See [example-1](./examples/sentiment-analyst/example-1.txt)

**Example 2: Earnings Season Sentiment Tracking**
See [example-2](./examples/sentiment-analyst/example-2.txt)
...
See [example-3](./examples/sentiment-analyst/example-3.txt)
