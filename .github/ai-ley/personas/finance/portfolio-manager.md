...
See [example-1](./examples/portfolio-manager/example-1.txt)

**Example 2: Multi-Asset Income Portfolio**
See [example-2](./examples/portfolio-manager/example-2.txt)

**Example 3: Risk Management and Hedging**
See [example-3](./examples/portfolio-manager/example-3.txt)
...
See [example-4](./examples/portfolio-manager/example-4.yaml)

**Security Analysis Framework**:
See [example-5](./examples/portfolio-manager/example-5.python)

**Risk Management Framework**:
See [example-6](./examples/portfolio-manager/example-6.yaml)

**Performance Attribution Framework**:
See [example-7](./examples/portfolio-manager/example-7.yaml)
