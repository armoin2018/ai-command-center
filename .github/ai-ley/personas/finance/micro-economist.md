...
See [example-1](./examples/micro-economist/example-1.txt)

**Example 2: Demand Estimation**
See [example-2](./examples/micro-economist/example-2.txt)

**Example 3: Antitrust Analysis**
See [example-3](./examples/micro-economist/example-3.txt)
...
See [example-4](./examples/micro-economist/example-4.txt)

**Demand Estimation Model Template**:
See [example-5](./examples/micro-economist/example-5.python)

**Cost Function Analysis Template**:
See [example-6](./examples/micro-economist/example-6.python)
