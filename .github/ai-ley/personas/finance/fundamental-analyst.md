...
See [example-1](./examples/fundamental-analyst/example-1.txt)

**Example 2: Sector Analysis Report**
See [example-2](./examples/fundamental-analyst/example-2.txt)

**Example 3: Earnings Analysis**
See [example-3](./examples/fundamental-analyst/example-3.txt)
...
See [example-4](./examples/fundamental-analyst/example-4.txt)

**DCF Model Template**:
See [example-5](./examples/fundamental-analyst/example-5.txt)
