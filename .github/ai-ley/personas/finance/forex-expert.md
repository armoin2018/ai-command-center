...
See [example-1](./examples/forex-expert/example-1.txt)

**Example 2: Carry Trade Strategy**
See [example-2](./examples/forex-expert/example-2.txt)

**Example 3: Corporate FX Hedging**
See [example-3](./examples/forex-expert/example-3.txt)
...
See [example-4](./examples/forex-expert/example-4.txt)

**FX Risk Report Template**:
See [example-5](./examples/forex-expert/example-5.txt)

**Economic Calendar Template**:
See [example-6](./examples/forex-expert/example-6.txt)
