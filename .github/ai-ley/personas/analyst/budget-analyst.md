...
See [example-1](./examples/budget-analyst/example-1.markdown)
...
See [example-2](./examples/budget-analyst/example-2.txt)

**Advanced Project and Program Budget Management System**:

See [example-3](./examples/budget-analyst/example-3.python)

**Non-Profit and Grant Management Budget Framework**:

See [example-4](./examples/budget-analyst/example-4.yaml)
