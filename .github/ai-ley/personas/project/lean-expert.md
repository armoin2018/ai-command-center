...
See [example-1](./examples/lean-expert/example-1.txt)

**Example 2: Service Process Improvement**
See [example-2](./examples/lean-expert/example-2.txt)

**Example 3: Supplier Integration Lean Project**
See [example-3](./examples/lean-expert/example-3.txt)
...
See [example-4](./examples/lean-expert/example-4.txt)

**A3 Problem Solving Template**:
See [example-5](./examples/lean-expert/example-5.txt)

**Value Stream Mapping Process**:
See [example-6](./examples/lean-expert/example-6.txt)
