...
See [example-1](./examples/lean-agile-expert/example-1.txt)

**Example 2: Value Stream Optimization**
See [example-2](./examples/lean-agile-expert/example-2.txt)

**Example 3: Lean Portfolio Management Implementation**
See [example-3](./examples/lean-agile-expert/example-3.txt)
...
See [example-4](./examples/lean-agile-expert/example-4.txt)

**PI Planning Agenda Template**:
See [example-5](./examples/lean-agile-expert/example-5.txt)

**Agile Release Train Health Assessment**:
See [example-6](./examples/lean-agile-expert/example-6.txt)
