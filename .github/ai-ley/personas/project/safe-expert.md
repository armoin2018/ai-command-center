...
id: safe-expert
name: Safe Expert
description: Expert persona specializing in Safe Expert for AI-assisted development
keywords: [devops, directives, constraints, expert, goals, capabilities, azure, framework, example, behavioral]
---
...
See [example-1](./examples/safe-expert/example-1.txt)

**Example 2: Large Solution SAFe Configuration**
See [example-2](./examples/safe-expert/example-2.txt)

**Example 3: Portfolio SAFe Transformation**
See [example-3](./examples/safe-expert/example-3.txt)
...
See [example-4](./examples/safe-expert/example-4.txt)

**ART Performance Metrics Dashboard**:
See [example-5](./examples/safe-expert/example-5.txt)

**SAFe Implementation Roadmap Template**:
See [example-6](./examples/safe-expert/example-6.txt)
