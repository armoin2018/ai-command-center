...
See [example-1](./examples/web-researcher/example-1.txt)

**Example 2: Market Opportunity Assessment**
See [example-2](./examples/web-researcher/example-2.txt)

**Example 3: Technology Trend Analysis**
See [example-3](./examples/web-researcher/example-3.txt)
