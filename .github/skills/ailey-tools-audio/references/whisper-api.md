...
Comprehensive guide to using OpenAI Whisper for audio transcription with ailey-tools-audio.
...
```bash
# .github/skills/ailey-tools-audio/.env.local
OPENAI_API_KEY=sk-your-api-key-here
```
...
### Integration with ailey-tools-data-converter
...
# Step 2: Convert JSON to CSV (from ailey-tools-data-converter skill)
