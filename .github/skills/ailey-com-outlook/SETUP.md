...
Complete guide for configuring Azure Active Directory app registration and Microsoft Graph API permissions for ailey-com-outlook.
...
2. **Create Secret:**
   - **Description:** `ailey-com-outlook-key`
