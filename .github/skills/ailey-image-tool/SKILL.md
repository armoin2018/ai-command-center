...
```bash
cd .github/skills/ailey-image-tool
npm install
npm run build
```
...
import { converter } from '.github/skills/ailey-image-tool/lib/converter.js';
import { editor } from '.github/skills/ailey-image-tool/lib/editor.js';
import { ocr } from '.github/skills/ailey-image-tool/lib/ocr.js';
...
- **ailey-data-converter**: Schema and data format conversions
