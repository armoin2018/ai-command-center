...
The ailey-audio-tool skill provides complete audio processing capabilities:
...
```bash
cd .github/skills/ailey-audio-tool
npm install
```
...
cd ../ailey-tag-n-rag
npm run process file ../ailey-audio-tool/transcript.txt --collection transcripts
```
