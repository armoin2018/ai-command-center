# ailey-com-email Skill - Implementation Complete ✅
...
### Calendar/Contacts ❌
- [ ] Not supported (IMAP limitation - use ailey-com-outlook for these features)
...
## Differences from ailey-com-outlook

| Feature | ailey-com-outlook | ailey-com-email |
|---------|-------------------|---------------------|
...
**When to use:**
- **ailey-com-outlook**: Office 365, need calendar/contacts, enterprise features
- **ailey-com-email**: Any provider, simple setup, email-only needs
...
The **ailey-com-email** skill is **COMPLETE** and ready for use with any IMAP/SMTP-compatible email provider. It provides a provider-agnostic alternative to cloud-only solutions like Microsoft Graph API.
...
### Limitations vs ailey-com-outlook
