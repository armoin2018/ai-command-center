...
| Feature | ailey-facebook | ailey-instagram |
|---------|----------------|-----------------|
...
| Aspect | ailey-instagram | ailey-outlook-email | ailey-standard-email |
|--------|-----------------|---------------------|---------------------|
...
- **ailey-tag-n-rag**: Index Instagram content for searchable archive
