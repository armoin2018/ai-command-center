...
The ailey-atl-jira skill provides bidirectional synchronization between Jira and `.project/PLAN.json`. This guide covers sync strategies, conflict resolution, and best practices.
