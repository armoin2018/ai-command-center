...
Quick setup guide for the ailey-atl-confluence skill.
...
3. Give it a name (e.g., "ailey-atl-confluence")
4. Click **"Create"**
...
npm run confluence crud create \
  ...
  --title "Test Page" \
  --content "<p>This is a test page created by ailey-atl-confluence</p>"
```
