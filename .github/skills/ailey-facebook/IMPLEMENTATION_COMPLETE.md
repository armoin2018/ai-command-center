...
1. `.github/skills/ailey-facebook/.env` (local)
2. `~/.vscode/.env` (global)
3. `.github/skills/ailey-facebook/.env.local` (local override)
...
### With Other Skills
1. **ailey-tag-n-rag**: Index social media content for searchable knowledge base
2. **ailey-jira**: Create issues from social feedback, track campaigns as projects
