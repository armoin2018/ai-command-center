...
> **Example:**
> ```bash
> # Assess all personas with verbose output
> npm run optimize assess personas -- --verbose
> 
> # Assess specific file
> npm run optimize assess .github/prompts/ailey-admin-assess.prompt.md
> 
...
> **Note:** The content below is retained for reference. Use the skill command above for actual execution.
...
- Read and parse `.github/prompts/ailey-add-instructions.prompt.md` for quality criteria
...
- Read and parse `.github/prompts/ailey-add-personas.prompt.md` for quality criteria
